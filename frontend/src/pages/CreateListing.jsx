...
const CreateListing = () => {
  ...
  const [price, setPrice] = useState(2345);
      ...
      await axios
        ...
        .then((response) => {
          ...
          setUserInfo((prevUserInfo) => ({
            ...prevUserInfo,
            propertyList: [...(prevUserInfo.propertyList || []), newProperty],
          }));
          navigate("/");
        })
        .catch((error) => {
        ...
        {currentStep === 3 && (
          <>
            ...
            <div className="flex flex-wrap flex-col justify-start gap-3 lg:gap-3.5 md:justify-center">
              <div
                className="relative inline-block md:max-w-[600px] w-full md:mx-auto"
                ref={dropdownRef}
              >
                <button
              ...
              <div className="relative inline-block md:max-w-[600px] mt-3 w-full md:mx-auto">
          ...
          <>
            ...
            <div className="flex flex-wrap justify-center gap-3 lg:gap-3.5 mx-auto w-full md:max-w-[650px]">
              <textarea
                autoFocus
                value={description}
                className="p-4 md:p-5 border border-black rounded-lg text-2xl min-h-36 smd:min-h-44 max-h-96 w-full no-scrollbar"
                maxLength="500"
                onChange={(e) => {
